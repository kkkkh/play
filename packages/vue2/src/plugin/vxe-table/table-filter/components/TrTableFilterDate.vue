<template>
  <div class="tr-table-filter-date">
    <template v-if="condition === 'in'">
      ...
      <ElDatePicker
        ...
        v-model="singleValue"
        :append-to-body="false"
        class="tr-table-filter-date__input"
        clearable
        :format="valueFormat"
        :size="size"
        type="date"
    ...
    <template v-else-if="condition === 'between'">
      <ElDatePicker
        v-model="$values"
        :append-to-body="false"
        class="tr-table-filter-date__range-input"
        clearable
        :format="valueFormat"
        :size="size"
        type="daterange"
...
export default {
  ...
  props: {
    condition: {
      type: String,
      default: getDefaultFilterCondition('date'),
    },
    multiple: {
      type: Boolean,
      default: false,
    ...
    valueFormat: {
      type: String,
      default: getDefaultValueFormat('date'),
    },
    valueOptions: {
      type: Array,
      default: () => [],
